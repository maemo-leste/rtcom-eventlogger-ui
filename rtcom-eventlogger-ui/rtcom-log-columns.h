...
#define RTCOM_LOG_VIEW_COL_TYPE_12 G_TYPE_INT64
#define RTCOM_LOG_VIEW_COL_TYPE_13 G_TYPE_INT
#define RTCOM_LOG_VIEW_COL_TYPE_14 G_TYPE_STRING
#define RTCOM_LOG_VIEW_COL_TYPE_15 G_TYPE_STRING
#define RTCOM_LOG_VIEW_COL_TYPE_16 G_TYPE_BOOLEAN
#define RTCOM_LOG_VIEW_COL_TYPE_17 G_TYPE_INT
